  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Construction Tool Rental v2 - Empowering individual customers to rent construction tools from our widespread outlets with ease and convenience."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Construction Tool Rental v2 - Empowering individual customers to rent construction tools from our widespread outlets with ease and convenience.`}
            </Text>
            <Box
